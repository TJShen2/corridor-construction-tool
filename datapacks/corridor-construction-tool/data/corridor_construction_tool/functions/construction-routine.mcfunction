...
tunnel 8 false smooth_stone bricks
# Fence is made of oak fence and has a height of 3m. Catenary is at a height of 8 and is gantry-mounted.
fence 3 gantry_mounted 8 20 "6,14" smooth_stone white_concrete bricks bricks oak_fence
# Pillar (insert your own schematic name before uncommenting)
# pillar 13 50 5 [schematic name] transverse smooth_stone
